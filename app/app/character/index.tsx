  ...
  return (
    <main className='flex flex-1 flex-col gap-4 p-4 pt-0'>
      ...
      <div className='w-full rounded-xl border border-border bg-card p-4 flex flex-col md:flex-row gap-6 md:items-center'>
        ...
        <div className='flex flex-1 flex-col gap-6 w-full'>
          ...
          <div className='flex items-center gap-4'>
            <Heart />
            <CharacterStats label='Health' value={85} maxValue={100} color='bg-green-600' height='h-4' />
          </div>
          <div className='flex items-center gap-4'>
            <Star />
            <CharacterStats label='Experience' value={15} maxValue={100} color='bg-yellow-500' height='h-4' />
          </div>
        </div>
      </div>
      ...
      <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
        <CharacterStats label='Strength' value={45} maxValue={100} color='bg-rose-500' height='h-2' />

        <CharacterStats label='Intelligence' value={90} maxValue={100} color='bg-sky-500' height='h-2' />

        <CharacterStats label='Resilience' value={15} maxValue={100} color='bg-emerald-500' height='h-' />
      </div>
